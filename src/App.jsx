...
// ── ADVERTISING ──
...[["FACEBOOK ADS","[FACEBOOK.COM](http://facebook.com/)"],["META ADS"],["GOOGLE ADS"],["YELP"],["THUMBTACK"],["HOMEADVISOR"],["ANGI "],["NEXTDOOR"],["VISTAPRINT"],["4IMPRINT"],["INDEED"],["ZIPRECRUITER"],["INSTY PRINTS"]].map(p=>({patterns:p,category:"Advertising & Marketing"})),
...
return (
<div style={S.app}>
<style>{        `@import url('<https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=Playfair+Display:wght@700&display=swap>');         *{box-sizing:border-box;margin:0;padding:0}         button:hover{opacity:0.85}         input:focus{border-color:#c8a96e!important;box-shadow:0 0 0 3px rgba(200,169,110,0.12)}         .cc:hover{background:#fafaf8!important;border-color:#c8a96e!important;cursor:pointer}         .btype{padding:8px 12px;border-radius:8px;border:1px solid #e8e4dc;background:#fff;cursor:pointer;font-family:inherit;font-size:12px;transition:all 0.15s}         .btype:hover,.btype.sel{border-color:#c8a96e;background:#fffbf4;font-weight:600}         .drop{border:2px dashed #e8e4dc;border-radius:12px;padding:48px 28px;text-align:center;cursor:pointer;transition:all 0.2s}         .drop:hover,.drop.over{border-color:#c8a96e;background:#fffbf4}         .ropt{padding:8px 13px;border-radius:8px;border:1px solid #e8e4dc;background:#fff;cursor:pointer;font-size:12px;font-family:inherit;transition:all 0.15s}         .ropt:hover{border-color:#c8a96e;background:#fffbf4}         .tr:hover{background:#fafaf8}         ::-webkit-scrollbar{width:4px}::-webkit-scrollbar-thumb{background:#ddd;border-radius:2px}         @keyframes spin{from{transform:rotate(0)}to{transform:rotate(360deg)}}`      }</style>
