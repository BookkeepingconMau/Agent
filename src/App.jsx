...
const BUSINESS_TYPES = [
  ...
  { id: "auto_repair",   label: "Auto Repair / Mecánico",    icon: "🔧" },
  { id: "general",       label: "General Services",          icon: "⚙️" },
  { id: "bookkeeping",   label: "Bookkeeping / Tax Prep",     icon: "📒" },
];
const tradesFuel = (cat) => ({ construction:cat,hvac:cat,roofing:cat,drywall:cat,electrical:cat,plumbing:cat,landscaping:cat,cleaning:"Vehicle - Fuel (Non-Production)",food_events:"Vehicle - Fuel (Non-Production)",restaurant:"Vehicle - Fuel (Non-Production)",trucking:"COGS - Fuel (Production)",property_mgmt:"Vehicle - Fuel (Non-Production)",barbershop:"Vehicle - Fuel (Non-Production)",auto_repair:cat,general:"Vehicle - Fuel (Non-Production)",bookkeeping:"Vehicle - Fuel (Non-Production)" });
// ── CAMBIO 1: "COGS - Materials" → "Materials" en tradesMat ──
const tradesMat  = (fallback="ASK TO CLIENT") => ({ construction:"Materials",hvac:"Materials",roofing:"Materials",drywall:"Materials",electrical:"Materials",plumbing:"Materials",landscaping:"Materials",cleaning:"Materials",food_events:"Materials",restaurant:fallback,trucking:"Operating Expenses - Supplies",property_mgmt:"Repairs & Maintenance",barbershop:"Materials",auto_repair:"Materials",general:fallback,bookkeeping:fallback });
...
6. CHECK IMAGE PAGES — CRITICAL: Pages showing scanned check photos have text lines
   formatted as "#NNNN MM/DD/YYYY $X,XXX.XX" below each image (two per row).
   These are NOT transactions — they are ALREADY captured in the CHECKS CLEARED table.
...
7. IGNORE the "Daily Balances" section — those are balances, not transactions.
...
const MERCHANT_DICT = [
  ...
  ...[["AUTOZONE"],["OREILLY","O'REILLY"],["ADVANCE AUTO"],["NAPA AUTO"],["PEP BOYS"],["FIRESTONE"],["GOODYEAR"],["MAVIS TIRE"],["DISCOUNT TIRE"],["WORLDPAC"],["CARQUEST"],["LKQ"],["ROCKAUTO"],["PARTS AUTHORITY"],["INTERSTATE BATTERIES"]].map(p=>({patterns:p,category:{auto_repair:"Materials",general:"Vehicle - Maintenance"}})),
  ...[["JIFFY LUBE"],["CAR WASH","CARWASH"]].map(p=>({patterns:p,category:"Vehicle - Maintenance"})),
  ...
  { patterns:["WALMART","WAL-MART","WM SUPERCENTER"], category:{construction:"Materials",hvac:"Materials",roofing:"Materials",drywall:"Materials",electrical:"Materials",plumbing:"Materials",landscaping:"Materials",cleaning:"Materials",food_events:"Materials",restaurant:"Materials",trucking:"Operating Expenses - Supplies",property_mgmt:"Operating Expenses - Supplies",barbershop:"Materials",auto_repair:"Materials",general:"Office Supplies"} },
  { patterns:["SAMS CLUB","SAM'S CLUB","SAMSCLUB"], category:{construction:"Materials",hvac:"Materials",roofing:"Materials",drywall:"Materials",electrical:"Materials",plumbing:"Materials",landscaping:"Materials",cleaning:"Materials",food_events:"Materials",restaurant:"Materials",trucking:"Operating Expenses - Supplies",property_mgmt:"Operating Expenses - Supplies",barbershop:"Materials",auto_repair:"Materials",general:"Office Supplies"} },
  { patterns:["COSTCO"], category:{construction:"Materials",hvac:"Materials",roofing:"Materials",drywall:"Materials",electrical:"Materials",plumbing:"Materials",landscaping:"Materials",cleaning:"Materials",food_events:"Materials",restaurant:"Materials",trucking:"Operating Expenses - Supplies",property_mgmt:"Operating Expenses - Supplies",barbershop:"Materials",auto_repair:"Materials",general:"Office Supplies"} },
  { patterns:["AMAZON"], category:{construction:"Materials",hvac:"Materials",roofing:"Materials",drywall:"Materials",electrical:"Materials",plumbing:"Materials",landscaping:"Materials",cleaning:"Materials",food_events:"Materials",restaurant:"ASK TO CLIENT",trucking:"Operating Expenses - Supplies",property_mgmt:"Repairs & Maintenance",barbershop:"Materials",auto_repair:"Materials",general:"Office Supplies"} },
  ...
  // -- ARVEST BANK / DEER CONCRETE (construction) --
...
function dedupeChecksByNumber(rows) {
  ...
  return rows.filter(r => {
    ...
    if (!m) return true;
    const num = m[1];
    // EXCEPCIÓN: cheques de caja sin folio (check #0, #00, etc.)
    // No se deduplican — varios cheques legítimos pueden compartir el número 0
...
function detectATMByAddress(concept, amount) {
  ...
  // Detecta conceptos que son direcciones de cajero automático:
  ...
  // Montos pequeños = surcharge / comisión del cajero. Montos mayores = retiro del dueño.
  return amt < 10
